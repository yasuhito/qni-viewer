...
class UnicodeFractionTest
  ...
  class FromStringTest < ActiveSupport::TestCase
    test '0' do
      ...
      assert_equal '0', fraction.to_wolfram
    end

    test '1/2' do
      fraction = UnicodeFraction('1/2')
      assert_equal '½', fraction.to_wolfram
    end
  ...
  class FromNumberWithEpsilonTest < ActiveSupport::TestCase
    test '0' do
      assert_equal '0', UnicodeFraction(0, 0.0005).to_wolfram
      assert_nil UnicodeFraction(0.0006, 0.0005)
      assert_nil UnicodeFraction(-0.0006, 0.0005)
    end

    test '1.0 / 2' do
      assert_equal '½', UnicodeFraction(1.0 / 2, 0.0005).to_wolfram
