...
JSON:
`{ "circuit": [[{"gate": "Phase", "phi": 1.5707963267948966}]] }`
...
JSON:
`{ "circuit": [[{"gate": 1}, {"gate": "Phase", "phi": 1.5707963267948966}]] }`
